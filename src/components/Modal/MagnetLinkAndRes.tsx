        ...
        <div>
            <section className="magnet-link-with-resolution mb-3 flex flex-col gap-2 alert bg-neutral shadow-lg w-80">
                ...
                <label className="input input-bordered flex items-center gap-2">
                    ...
                    <input type="text" id={"magnet-link-" + magnetLinkId} className="grow" placeholder="Link" />
                </label>
                <label className="input input-bordered flex items-center gap-2">
                    ...
                    <input type="text" id={"resolution-" + magnetLinkId} className="grow" placeholder="Resolução" />
                </label>
            </section>
        </div>
    )
...
export default MagnetLinkAndRes