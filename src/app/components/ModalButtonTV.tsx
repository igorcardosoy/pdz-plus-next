...
const ModalButtonTV: React.FC<ModalButtonTVProps> = ({ modalId = 0, midia = {} as PDZ_midia }) => {
  ...
  return (
    <div className="d-flex flex-wrap gap-3 text-center align-items-center justify-content-center">
      <div className={`seasons-${modalId}`}>
        <select onChange={handleChangeSeason} className="form-select">
      ...
      <div className={`episodes-${modalId}`}>
        <select onChange={handleChangeEpisode} className="form-select">
